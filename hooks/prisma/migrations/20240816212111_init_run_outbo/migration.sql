...
-- CreateIndex
CREATE INDEX "_ActionToTrigger_B_index" ON "_ActionToTrigger"("B");
...
-- AddForeignKey
ALTER TABLE "_ActionToTrigger" ADD CONSTRAINT "_ActionToTrigger_B_fkey" FOREIGN KEY ("B") REFERENCES "Trigger"("id") ON DELETE CASCADE ON UPDATE CASCADE;
